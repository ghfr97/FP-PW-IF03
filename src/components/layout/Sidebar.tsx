  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex items-center space-x-3">
        ...
        <div>
          <h2 className="font-syne font-bold text-xl text-gray-800 dark:text-white">FreshWave</h2>
                ...
                className={({ isActive }) =>
                  `flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 group ${
                    isActive
                      ...
                      : 'text-gray-500 dark:text-gray-400 hover:bg-sky/5 hover:text-sky dark:hover:bg-sky/10 dark:hover:text-sky'
                  }`
                }
              >
      ...
      <div className="p-4 border-t border-gray-100 dark:border-gray-800">
        <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800">
          ...
          <div className="ml-3 flex-1 overflow-hidden">
            <p className="font-bold text-gray-800 dark:text-white truncate text-sm">Admin Utama</p>
